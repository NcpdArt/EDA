...
// ERRO DOS NOMES DAS MARCAS (A MARCA ESTA PRESO NUMA CONSTANTE PARA TODOS OS ET) NESSE LOOP E ERRO NOS MODELOS(OS MODELOS MUDA DE ET PARA ET, MAS N ESTAO RANDOM ESTAO POR ODEM DO TXT), ERRO QUE QUANDO OS CARROS SAO 0 A MARCA NO ET FICA VAZIA
